      ...
      <div className="space-y-4 sm:space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 sm:mb-6 gap-3 sm:gap-4">
          <div className="min-w-0 flex-1">
            ...
            <p className="text-gray-600 text-sm sm:text-base">View recent inspection photos from schools</p>
          </div>
          ...
          {reportTypes.map((type) => {
            ...
            return (
              <button
                ...
                className={`w-full sm:w-auto flex items-center justify-between sm:justify-start gap-2 px-4 py-3 rounded-xl border min-h-[48px] sm:min-h-[44px] touch-manipulation text-sm sm:text-base transition-all ${
                  isActive
